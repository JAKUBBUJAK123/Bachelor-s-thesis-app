    ...
    return (
        ...
        <View style={styles.wrapper}>
          <TouchableOpacity style={styles.button} onPress={() => {navigation.navigate('ScreenB')}}>
            <Image source={require('../assets/localization.png')} style={styles.homeIcon}/>
          </TouchableOpacity>
        </View>
        <View style={styles.wrapper}>
        ...
        <View style={styles.wrapper}>
          <TouchableOpacity style={styles.button} onPress={() => {navigation.navigate('ScreenD')}}>
            <Image source={require('../assets/profile-picture.png')} style={styles.homeIcon}/>
          </TouchableOpacity>
        </View>
      </View>
    )
